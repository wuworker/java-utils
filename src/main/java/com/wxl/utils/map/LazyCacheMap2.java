 ...
 */
@UnThreadSafe
public class LazyCacheMap2<K, V> extends AbstractCacheMap<K, V>
    ...
    public LazyCacheMap2() {
        cacheMap = new HashMap<>();
    }

    public LazyCacheMap2(int initialCapacity) {
        cacheMap = new HashMap<>(initialCapacity);
    }

    public LazyCacheMap2(int initialCapacity, float loadFactor) {
        cacheMap = new HashMap<>(initialCapacity, loadFactor);
    }

    public LazyCacheMap2(Map<K, CacheEntry<K, V>> cacheMap) {
    ...
    @Override
    public LazyCacheMap2<K, V> clone() throws CloneNotSupportedException {
        clearExpire();
        LazyCacheMap2<K, V> result;
        try {
            result = (LazyCacheMap2<K, V>) super.clone();
    ...
    final class KeySet extends AbstractSet<K> {
        public int size() {
            return LazyCacheMap2.this.size();
        }

        public void clear() {
            LazyCacheMap2.this.clear();
        }
        ...
        public boolean contains(Object o) {
            return LazyCacheMap2.this.containsKey(o);
        }
        ...
        public void forEach(Consumer<? super K> action) {
            LazyCacheMap2.this.forEach((k, v) -> action.accept(k));
        }
    ...
    final class Values extends AbstractCollection<V> {
        ...
        public boolean contains(Object o) {
            return LazyCacheMap2.this.containsValue(o);
        }
        ...
        public void forEach(Consumer<? super V> action) {
            LazyCacheMap2.this.forEach((k, v) -> action.accept(v));
        }
    ...
    final class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        public String toString() {
            return LazyCacheMap2.this.toString();
        }
        ...
        public boolean remove(Object o) {
            if (o instanceof Entry) {
                Entry<?, ?> entry = (Entry<?, ?>) o;
                return LazyCacheMap2.this.remove(entry.getKey(), entry.getValue());
            }
            return false;
        }
